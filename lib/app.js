...
app.get('/budget',
  ...
  function (req, res, next) {
    co(function* () {
      ...
      const onlyExpenseTransactions = _.filter(transactions, t => t.Category.CategoryType === 'Expenses');
      ...
      // By categories
      const categoriesStr = yield redisClient.getAsync('meniga:categories');
